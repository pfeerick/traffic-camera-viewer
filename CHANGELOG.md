...
- **ci**: don't let main pushes cancel each other's CI runs
- **ci**: queue overlapping release runs instead of cancelling them
- **release**: normalize CRLF before cz's internal bump commit
